export const dict = {
  ...
  "home.globalBoard": "Global board",
  "home.empty.title": "No recent projects",
  "home.empty.description": "Get started by opening a local project",

  "board.short": "Board",
  "board.global.title": "Global board",
  "board.global.description": "Track work shared across every project in one place.",
  "board.project.title": "{{project}} board",
  "board.project.description": "Plan project work here and keep cards in sync with chat actions.",
  "board.chat": "Use this board manually or ask chat to create cards, move tasks, or reshape columns for you.",
  "board.toast.failed": "Board update failed",
  "board.moveLeft": "Move left",
  "board.moveRight": "Move right",
  "board.moveUp": "Move up",
  "board.moveDown": "Move down",
  "board.column.new": "Add column",
  "board.column.rename": "Rename column",
  "board.column.edit": "Edit column",
  "board.column.name": "Column name",
  "board.column.name.placeholder": "Column name",
  "board.column.delete.confirm": 'Delete "{{name}}"? Existing cards will move to "{{next}}".',
  "board.card.new": "Add card",
  "board.card.edit": "Edit card",
  "board.card.title": "Title",
  "board.card.title.placeholder": "Card title",
  "board.card.description": "Description",
  "board.card.description.placeholder": "Add more details for this task",
  "board.card.delete.confirm": 'Delete "{{title}}"?',
  "board.card.color": "Card color",
  "board.card.drop": "Drop a card here",
  "board.tags": "Tags",
  "board.tag.add": "Add tag",
  "board.tag.empty": "No tags yet. Add labels to make cards easier to scan.",
  "board.tag.name": "Tag name",
  "board.tag.name.placeholder": "Tag name",
  "board.color.none": "No color",
  "board.color.slate": "Slate",
  "board.color.gray": "Gray",
  "board.color.blue": "Blue",
  "board.color.violet": "Violet",
  "board.color.green": "Green",
  "board.color.amber": "Amber",
  "board.color.orange": "Orange",
  "board.color.red": "Red",
  "board.color.pink": "Pink",
  "board.color.cyan": "Cyan",
  "board.dragColumn": "Drag column",
  "board.dragCard": "Drag card",
  "board.note.project": "Project note",
  "board.note.global": "Global note",
  "board.note": "Note",
