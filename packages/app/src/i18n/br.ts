export const dict = {
  ...
  "home.globalBoard": "Board global",
  "home.empty.title": "Nenhum projeto recente",
  "home.empty.description": "Comece abrindo um projeto local",
  "board.short": "Board",
  "board.global.title": "Board global",
  "board.global.description": "Acompanhe trabalho compartilhado entre todos os projetos em um unico lugar.",
  "board.project.title": "Board de {{project}}",
  "board.project.description": "Planeje o trabalho do projeto aqui e mantenha os cards em sincronia com o chat.",
  "board.chat": "Use este board manualmente ou peca ao chat para criar cards, mover tarefas e reorganizar colunas.",
  "board.toast.failed": "Falha ao atualizar o board",
  "board.moveLeft": "Mover para a esquerda",
  "board.moveRight": "Mover para a direita",
  "board.moveUp": "Mover para cima",
  "board.moveDown": "Mover para baixo",
  "board.column.new": "Nova coluna",
  "board.column.rename": "Renomear coluna",
  "board.column.edit": "Editar coluna",
  "board.column.name": "Nome da coluna",
  "board.column.name.placeholder": "Nome da coluna",
  "board.column.delete.confirm": 'Excluir "{{name}}"? Os cards existentes vao para "{{next}}".',
  "board.card.new": "Novo card",
  "board.card.edit": "Editar card",
  "board.card.title": "Titulo",
  "board.card.title.placeholder": "Titulo do card",
  "board.card.description": "Descricao",
  "board.card.description.placeholder": "Adicione mais detalhes para esta tarefa",
  "board.card.delete.confirm": 'Excluir "{{title}}"?',
  "board.card.color": "Cor do card",
  "board.card.drop": "Solte um card aqui",
  "board.tags": "Tags",
  "board.tag.add": "Adicionar tag",
  "board.tag.empty": "Nenhuma tag ainda. Adicione rotulos para escanear os cards mais rapido.",
  "board.tag.name": "Nome da tag",
  "board.tag.name.placeholder": "Nome da tag",
  "board.color.none": "Sem cor",
  "board.color.slate": "Slate",
  "board.color.gray": "Cinza",
  "board.color.blue": "Azul",
  "board.color.violet": "Violeta",
  "board.color.green": "Verde",
  "board.color.amber": "Ambar",
  "board.color.orange": "Laranja",
  "board.color.red": "Vermelho",
  "board.color.pink": "Rosa",
  "board.color.cyan": "Ciano",
  "board.dragColumn": "Arrastar coluna",
  "board.dragCard": "Arrastar card",
  "board.note.project": "Nota do projeto",
  "board.note.global": "Nota global",
  "board.note": "Nota",
  "board.collection": "Coleção",
